  ...
  <el-row class="container">
    <el-col :span="24" class="header">
      <el-col :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
        <!--{{collapsed?'':sysName}}-->
        <!--<img v-if="!collapsed" src="../assets/menu_logo_logo.png" alt="">-->
        <!--<img v-else src="../assets/menu_logo_logo2.png" alt="">-->
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover">
          <span class="user-title">分析系统</span>
        ...
        <ul class="el-menu el-menu-vertical-demo collapsed" v-show="collapsed" ref="menuCollapsed">
          <li v-for="(item,index) in $router.options.routes" v-if="!item.hidden" class="el-submenu item">
            <template v-if="!item.leaf">
              ...
              <div class="el-menu submenu" :class="'submenu-hook-'+index" @mouseover="showMenu(index,true)"
