<template>
	<section>
		...
		<el-table :data="list" highlight-current-row style="width: 100%;">
				...
				<el-table-column prop="type" label="人群范围" >
				...
				<el-table-column label="操作" >
					<template slot-scope="scope">
						<el-button type="primary" size="small" @click="$router.push({path:'/personDetail?type=node',query:{name:scope.row.name}})">查看</el-button>
					</template>
				</el-table-column>
		</el-table>
		<!--工具条-->
