		...
		<el-table :data="list" highlight-current-row style="width: 100%;">
			...
			<el-table-column label="操作" >
				<template slot-scope="scope">
					<el-button type="primary" size="small" @click="$router.push({path:'/personDetail?type=node',query:{name:scope.row.pName}})">查看</el-button>
					<el-button size="small" @click="$router.push({path:'/keyPersonEdit',query:{name:scope.row.pName}})">编辑</el-button>
